...
with open('./UNSW/UNSW-NB15_1.csv', "r", encoding='utf-8-sig') as file_1:
    file_1 = file_1.read()
wf = open("merge.csv", "a")
wf.write(file_1)
wf.close()

with open('./UNSW/UNSW-NB15_2.csv', "r", encoding='utf-8-sig') as file_2:
    file_2 = file_2.read()
wf = open("merge.csv", "a")
wf.write(file_2)
wf.close()

with open('./UNSW/UNSW-NB15_3.csv', "r", encoding='utf-8-sig') as file_3:
    file_3 = file_3.read()
wf = open("merge.csv", "a")
wf.write(file_3)
wf.close()

with open('./UNSW/UNSW-NB15_4.csv', "r", encoding='utf-8-sig') as file_4:
    file_4 = file_4.read()
wf = open("merge.csv", "a")
wf.write(file_4)
wf.close()

with open("merge.csv", "r", encoding='utf-8-sig') as file:
    file = file.read()
