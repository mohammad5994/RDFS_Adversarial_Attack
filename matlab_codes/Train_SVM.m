...
data_H0_matrix=sprintf('/home/ehsan/Desktop/Mohammad_Label_Flip/RDFS_Flipping/10_Percent/192/inter_feature_50/StammNet_subset_pristine_%d.npy',jj);
data_H1_matrix=sprintf('/home/ehsan/Desktop/Mohammad_Label_Flip/RDFS_Flipping/10_Percent/192/inter_feature_50/StammNet_subset_resize08_%d.npy',jj);
...
cv_idx_H0 = 12493:13729;    % 1000 for cross validation
cv_idx_H1 = cv_idx_H0;
tr_idx_H0 = 1:12492;          % 20000 for training
tr_idx_H1 = tr_idx_H0;
te_idx_H0 = 13730:16728;    % 4000 for testing
te_idx_H1 = te_idx_H0;
...
% % % %---------------------------------------------------------------------
% % % 
results=sprintf('/home/ehsan/fliipimg_mat_files/10_percent/192/results_%d.mat',jj);
...
acc=sprintf('/home/ehsan/fliipimg_mat_files/10_percent/192/results_%d.mat',jj);
